...
fig6, (ax1, ax2) = plt.subplots(nrows=1, ncols=2, figsize=(15, 10))
...
# plt.subplot(2, 2, 2)
# sns.barplot(x="frequency", y="customer_id", data=rfm_df.sort_values(by="frequency", ascending=False).head(5), palette=colors)
# plt.ylabel(None)
# plt.xlabel(None)
...
# plt.subplot(2, 1, 2)
# sns.barplot(x="monetary", y="customer_id", data=rfm_df.sort_values(by="monetary", ascending=False).head(5), palette=colors)
# plt.ylabel(None)
# plt.xlabel(None)
